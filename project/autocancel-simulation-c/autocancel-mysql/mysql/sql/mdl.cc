...
MDL_context::acquire_lock(MDL_request *mdl_request, ulong lock_wait_timeout)
{
  ...
  if (mdl_request->ticket)
  {
    ...
    */
    ...
    addRscOccupy(mdl_request->ticket, (char *) "mdlLockWait");       // autocancel
#endif
    return FALSE;
  }
...
{
#ifdef HAVE_AUTOCANCEL
  //int tid = syscall(SYS_gettid);                   // autocancel
  //addRscOccupy((void *)tid, (char *) "mdlLockWait");       // autocancel
#endif
...
#ifdef HAVE_AUTOCANCEL
  getRscOccupy(ticket, "mdlLockWait");                    //autocancel
#endif
...
#ifdef HAVE_AUTOCANCEL
  //int tid = syscall(SYS_gettid);                       // autocancel
  //getRscOccupy((void *)tid, (char *) "mdlLockWait");           // autocancel
#endif
  DBUG_VOID_RETURN;
}
