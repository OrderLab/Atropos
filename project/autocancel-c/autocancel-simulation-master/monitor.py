...
# socket
serverAddr = '/home/catbeat/mysql-5.6.51/dist/mysqld.sock'
...
if __name__ == "__main__":
    ...
    os.system("sysbench /usr/local/share/sysbench/oltp_read_only.lua --mysql-socket=/home/catbeat/mysql-5.6.51/dist/mysqld.sock --db-driver=mysql --mysql-port=3306 --mysql-user=root --mysql-password=adgjla --mysql-db=test --tables=3 --table-size=100000 --threads=2 --time=60 --report-interval=0.1 run > ./output 2>&1 &")
