	...
	mtr_t*		mtr)		/*!< in: mtr */
{
	...
	//struct timespec tp;				// autocancel
	//long long ptime, ntime; 		// autocancel
#endif
	...
	case BTR_MODIFY_LEAF:
		...
		//addRscUsageWait(ntime - ptime, (char *) "mtr_index");
#endif
		// autocancel end
...
# endif /* BTR_CUR_HASH_ADAPT */
	...
	default:
		if (!s_latch_by_caller) {
			...
			//struct timespec tp;
			//clock_gettime(CLOCK_REALTIME, &tp);
			//long long ptime  = tp.tv_sec * 1000000000L + tp.tv_nsec;
#endif
			// autocancel end
...
#ifdef HAVE_AUTOCANCEL
			//clock_gettime(CLOCK_REALTIME, &tp);
			//long long ntime  = tp.tv_sec * 1000000000L + tp.tv_nsec;
			//addRscUsageWait(ntime - ptime, (char *) "mtr_index");
#endif
			// autocancel end
		}
