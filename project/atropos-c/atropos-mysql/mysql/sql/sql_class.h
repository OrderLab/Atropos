...
/*
extern "C" unsigned long thd_thread_id (MYSQL_THD thd);
extern std::map<void *, unsigned long> & thd_lock_occupy_map(MYSQL_THD thd);
extern std::map<void *, unsigned long> & thd_lock_wait_map(MYSQL_THD thd);
extern "C" unsigned long *thd_lock_time_count(MYSQL_THD thd);
*/
#endif
// autocancel end
...
public:
  ...
  // autocancel begin
#ifdef HAVE_AUTOCANCEL
  std::map<void *, unsigned long> lock_occupy_map;
  std::map<void *, unsigned long> lock_wait_map;
  long long estimatedRows;
  char packet_command[100];
  int packet_length;
  char rerun_packet_command[100];
  int rerun_packet_length;
  enum enum_server_command rerun_m_command;
  int rerun_flag;
  long long rerun_time;
#endif
  // autocancel end
